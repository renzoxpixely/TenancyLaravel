                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr> {{-- protected $fillable = ['codigo','name','sale_price_igv','type_product','sku','branch_id','quantity', 'alternative_code']; --}}
                                            ...
                                            <td><span
                                                    class="lable-tag tag-success">{{ $product->purchase_price_noigv }}</span>
                                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <!-- Standard button -->
                        <div class="chart-box over-hidden">
                            <button data-dismiss="modal" data-toggle="modal" data-target="#addServiceModal"
                                type="button" class="btn btn-primary btn-lg btn-block">Servicios</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <!-- Standard button -->
                        <div class="chart-box over-hidden">
                            <button data-dismiss="modal" data-toggle="modal" data-target="#addPromotionModal"
                                type="button" class="btn btn-primary btn-lg btn-block">Promociones</button>
                        </div>
                    </div>
