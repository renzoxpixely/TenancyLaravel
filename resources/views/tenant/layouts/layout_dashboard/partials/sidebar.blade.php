  ...
  <aside class="main-sidebar dark-bg">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{ Route::is('tenant.branches.sales.index', $branch_id) ? 'active' : '' }} {{ Route::is('tenant.branches.clients.index', $branch_id) ? 'active' : '' }} {{ Route::is('tenant.branches.dispatches.index', $branch_id) ? 'active' : '' }}"><a href="#"><i class="fa fa-dashboard"></i> <span>Ventas</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu ">
            ...
            <li class="{{ Route::is('tenant.branches.dispatches.index', $branch_id) ? 'active' : '' }}"><a href="{{ route('tenant.branches.dispatches.index', $branch_id) }}"><i class="fa fa-angle-right"></i> Despachos </a></li>
          </ul>
        </li>
