    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- Tasks Menu -->
          <!-- User Account Menu -->
          <li class="dropdown user user-menu"> <a href="{{ route('tenant.branches.index') }}" class="dropdown-toggle"> <img src="{{ asset('assetsAdmin/dist/img/img1.jpg') }}" class="user-image" alt="User Image"> <span class="h4">Empresa y Locales</span> </a>
          </li>
