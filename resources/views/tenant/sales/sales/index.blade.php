    ...
    <div class="row">
        <div class="pull-right m-2">
          ...
          <ul class="dropdown-menu">
            <li><a  href="{{ route('tenant.branches.sales.create', $branch_id) }}">Venta</a></li>
            <li><a href="#">Orden de Venta</a></li>
      ...
      <table id="example" class="table table-striped table-bordered table-responsive" style="width:100%">
        ...
        @foreach ($sales as $sale)
                                <tr>
                                    ...
                                    @endif
                                    <td style="width: 20%;">
                                    <a class="" href="{{route('tenant.sales.show', $sale)}}" title="Ver detalles"><i class="fa fa-credit-card" aria-hidden="true"></i></a>       
                    
                  
                                        <!-- <a href="{{route('tenant.sales.show', $sale)}}" class="btn btn-outline-info"
                                        title="Ver detalles"
            ...
            buttons: [
                {
                    ...
                    action: function ( e, dt, node, conf ) {
                        window.location.href = "{{ route('tenant.branches.sales.create', $branch_id) }}"
                    }
                }
            ]
        });
